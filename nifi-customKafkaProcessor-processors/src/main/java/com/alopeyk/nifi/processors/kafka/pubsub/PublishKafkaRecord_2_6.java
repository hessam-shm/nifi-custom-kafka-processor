...
@SeeAlso({com.alopeyk.nifi.processors.kafka.pubsub.PublishKafka_2_6.class, com.alopeyk.nifi.processors.kafka.pubsub.ConsumeKafka_2_6.class, ConsumeKafkaRecord_2_6.class})
public class PublishKafkaRecord_2_6 extends AbstractProcessor {
    ...
    static final AllowableValue ROUND_ROBIN_PARTITIONING = new AllowableValue(com.alopeyk.nifi.processors.kafka.pubsub.Partitioners.RoundRobinPartitioner.class.getName(),
        com.alopeyk.nifi.processors.kafka.pubsub.Partitioners.RoundRobinPartitioner.class.getSimpleName(),
    ...
    static final AllowableValue RECORD_PATH_PARTITIONING = new AllowableValue(com.alopeyk.nifi.processors.kafka.pubsub.Partitioners.RecordPathPartitioner.class.getName(),
    ...
    static final AllowableValue EXPRESSION_LANGUAGE_PARTITIONING = new AllowableValue(com.alopeyk.nifi.processors.kafka.pubsub.Partitioners.ExpressionLanguagePartitioner.class.getName(), "Expression Language Partitioner",
    ...
    private volatile com.alopeyk.nifi.processors.kafka.pubsub.PublisherPool publisherPool = null;
    private final RecordPathCache recordPathCache = new RecordPathCache(25);

    static {
        final List<PropertyDescriptor> properties = new ArrayList<>();
        properties.add(com.alopeyk.nifi.processors.kafka.pubsub.KafkaProcessorUtils.BOOTSTRAP_SERVERS);
        ...
        properties.add(com.alopeyk.nifi.processors.kafka.pubsub.KafkaProcessorUtils.SECURITY_PROTOCOL);
        properties.add(com.alopeyk.nifi.processors.kafka.pubsub.KafkaProcessorUtils.SASL_MECHANISM);
        properties.add(com.alopeyk.nifi.processors.kafka.pubsub.KafkaProcessorUtils.KERBEROS_CREDENTIALS_SERVICE);
        properties.add(com.alopeyk.nifi.processors.kafka.pubsub.KafkaProcessorUtils.JAAS_SERVICE_NAME);
        properties.add(com.alopeyk.nifi.processors.kafka.pubsub.KafkaProcessorUtils.USER_PRINCIPAL);
        properties.add(com.alopeyk.nifi.processors.kafka.pubsub.KafkaProcessorUtils.USER_KEYTAB);
        properties.add(com.alopeyk.nifi.processors.kafka.pubsub.KafkaProcessorUtils.USERNAME);
        properties.add(com.alopeyk.nifi.processors.kafka.pubsub.KafkaProcessorUtils.PASSWORD);
        properties.add(com.alopeyk.nifi.processors.kafka.pubsub.KafkaProcessorUtils.TOKEN_AUTH);
        properties.add(com.alopeyk.nifi.processors.kafka.pubsub.KafkaProcessorUtils.SSL_CONTEXT_SERVICE);
    ...
    protected PropertyDescriptor getSupportedDynamicPropertyDescriptor(final String propertyDescriptorName) {
        return new Builder()
            ...
            .addValidator(new com.alopeyk.nifi.processors.kafka.pubsub.KafkaProcessorUtils.KafkaConfigValidator(ProducerConfig.class))
            .dynamic(true)
            .expressionLanguageSupported(VARIABLE_REGISTRY)
            .build();
    }
    ...
    protected Collection<ValidationResult> customValidate(final ValidationContext validationContext) {
        ...
        results.addAll(com.alopeyk.nifi.processors.kafka.pubsub.KafkaProcessorUtils.validateCommonProperties(validationContext));
    ...
    private synchronized com.alopeyk.nifi.processors.kafka.pubsub.PublisherPool getPublisherPool(final ProcessContext context) {
        com.alopeyk.nifi.processors.kafka.pubsub.PublisherPool pool = publisherPool;
        if (pool != null) {
            return pool;
        }
    ...
    protected com.alopeyk.nifi.processors.kafka.pubsub.PublisherPool createPublisherPool(final ProcessContext context) {
        ...
        Supplier<String> transactionalIdSupplier = com.alopeyk.nifi.processors.kafka.pubsub.KafkaProcessorUtils.getTransactionalIdSupplier(transactionalIdPrefix);

        final String charsetName = context.getProperty(MESSAGE_HEADER_ENCODING).evaluateAttributeExpressions().getValue();
        final Charset charset = Charset.forName(charsetName);

        final Map<String, Object> kafkaProperties = new HashMap<>();
        com.alopeyk.nifi.processors.kafka.pubsub.KafkaProcessorUtils.buildCommonKafkaProperties(context, ProducerConfig.class, kafkaProperties);
        kafkaProperties.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, ByteArraySerializer.class.getName());
        kafkaProperties.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, ByteArraySerializer.class.getName());
        kafkaProperties.put("max.request.size", String.valueOf(maxMessageSize));

        return new com.alopeyk.nifi.processors.kafka.pubsub.PublisherPool(kafkaProperties, getLogger(), maxMessageSize, maxAckWaitMillis, useTransactions, transactionalIdSupplier, attributeNamePattern, charset);
    }
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        final com.alopeyk.nifi.processors.kafka.pubsub.PublisherPool pool = getPublisherPool(context);
        if (pool == null) {
            context.yield();
            return;
        }
        ...
        try (final com.alopeyk.nifi.processors.kafka.pubsub.PublisherLease lease = pool.obtainPublisher()) {
            try {
                if (useTransactions) {
                ...
                // Complete the send
                final com.alopeyk.nifi.processors.kafka.pubsub.PublishResult publishResult = lease.complete();
                ...
                for (FlowFile success : flowFiles) {
                    ...
                    final String transitUri = com.alopeyk.nifi.processors.kafka.pubsub.KafkaProcessorUtils.buildTransitURI(securityProtocol, bootstrapServers, topic);
