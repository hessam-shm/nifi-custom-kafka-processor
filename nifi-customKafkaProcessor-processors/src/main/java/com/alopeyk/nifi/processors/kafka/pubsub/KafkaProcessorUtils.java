...
public final class KafkaProcessorUtils {
    ...
    public static final class KafkaConfigValidator implements Validator {
        ...
        public ValidationResult validate(final String subject, final String value, final ValidationContext context) {
            final boolean knownValue = com.alopeyk.nifi.processors.kafka.pubsub.KafkaProcessorUtils.isStaticStringFieldNamePresent(subject, classType, CommonClientConfigs.class, SslConfigs.class, SaslConfigs.class);
    ...
    public static boolean isStaticStringFieldNamePresent(final String name, final Class<?>... classes) {
        return com.alopeyk.nifi.processors.kafka.pubsub.KafkaProcessorUtils.getPublicStaticStringFieldValues(classes).contains(name);
    }
